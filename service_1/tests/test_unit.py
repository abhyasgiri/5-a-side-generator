...
class TestResponse(TestBase):
    ...
    def test_one(self):
        with requests_mock.mock() as a:
            a.get("http://football-cards_nation-backend:5002/league", text="English")
            a.get("football-cards_pack-backend:5000/pack", text="Gold")
            a.post("http://football-cards_player-backend/player", text="Pogba")
